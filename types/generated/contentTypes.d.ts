...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  attributes: {
    penName: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    penEmail: Attribute.Email &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBondBond extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<["analysis", "other"]> &
      Attribute.Required &
      Attribute.DefaultTo<"other">;
    from: Attribute.Relation<"api::bond.bond", "manyToOne", "api::post.post">;
    to: Attribute.Relation<"api::bond.bond", "manyToOne", "api::post.post">;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    beforeContent: Attribute.RichText &
      Attribute.CustomField<
        "plugin::ckeditor.CKEditor",
        {
          output: "Markdown";
    ...
    afterContent: Attribute.RichText &
      Attribute.CustomField<
        "plugin::ckeditor.CKEditor",
        {
          output: "Markdown";
    ...
    readingTimeInMinutes: Attribute.Integer &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    featured: Attribute.Boolean &
      ...
      Attribute.DefaultTo<false>;
    likedByUsers: Attribute.Relation<
      "api::post.post",
      "manyToMany",
      "plugin::users-permissions.user"
    >;
    ...
    fromBonds: Attribute.Relation<
      "api::post.post",
      "oneToMany",
      "api::bond.bond"
    >;
    toBonds: Attribute.Relation<
      "api::post.post",
      "oneToMany",
      "api::bond.bond"
    >;
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      "plugin::users-permissions.role"
    >;
    enablePrivacyPolicy: Attribute.Boolean &
      Attribute.Required &
      Attribute.Private &
      Attribute.DefaultTo<false>;
    subscribedToNewsletter: Attribute.Boolean &
      ...
      Attribute.Private &
      Attribute.DefaultTo<false>;
    likedAuthors: Attribute.Relation<
      "plugin::users-permissions.user",
      "oneToMany",
      "api::author.author"
    >;
